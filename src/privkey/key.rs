...
pub fn get_privkey(
    ...
    if let Some(input_str) = input {
        ...
        if input_str.len() == 64 {
            ...
            if let Ok(decoded_bytes) = hex::decode(input_str) {
    ...
    // Try to get the private key from the specified file or profile
...
impl PrivKey {
    ...
    pub fn stdin(max_attempts: usize, timeout_seconds: u64) -> Result<Self> {
